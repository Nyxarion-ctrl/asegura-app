...
export default function AdminPage() {
  ...
  // Función para abrir WhatsApp con el mensaje precargado
  const sendWhatsAppNotification = (item: Appointment) => {
    // Limpia caracteres no numéricos del número de teléfono
    let cleanPhone = item.client_phone ? item.client_phone.replace(/\D/g, "") : "";

    // Si no incluye código de país (10 dígitos), agrega por defecto el +1 (RD)
